...
int test_path_open_cases ( char *name )
{
    ...
    // Print tests
    print_test(name, "file.txt"       , test_path_open("test cases/file.txt"        , construct_file           , one));
    print_test(name, "file size.txt"  , test_path_open("test cases/file size.txt"   , construct_file_size      , one));
    print_test(name, "directory"      , test_path_open("test cases/directory/"      , construct_directory      , one));
    print_test(name, "directory file" , test_path_open("test cases/directory file/" , construct_directory_file , one));
    print_test(name, "directory files", test_path_open("test cases/directory files/", construct_directory_files, one));
    print_test(name, "directory mixed", test_path_open("test cases/directory mixed/", construct_directory_mixed, one));
...
bool test_path_open ( char *path_string, int (*expected_path_constructor) (path **), result_t expected )
{
    ...
    // Construct the path
    if ( expected_path_constructor == (void *) 0 )
        return false;
    ...
    ret = value_equals(p_expected_path, p_result_path);
